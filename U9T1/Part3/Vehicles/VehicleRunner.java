...
public class VehicleRunner {
    public static void main(String[] args) {
        ...
        // Vehicle jim = new Vehicle("MC56WQ", 10.75, 5);
        // System.out.println(jim.calculateTollPrice());
        ...
        // Car john = new Car("KXN73F", 8.5, 2, true);
        // System.out.println(john.calculateTollPrice());
        ...
        // //    Print out the calculated toll price
        // Truck jess = new Truck("3K9JMX", 24.75, 4, 6, true);
        // System.out.println(jess.calculateTollPrice());
        ...
        Taxi jamal = new Taxi("8KM23Z", 9.25, 3, true, 5);
        // jamal.printTaxi();
        // System.out.println();

        // System.out.println(jamal.getLicensePlate() + "\n" + jamal.getTollFee() + "\n" + jamal.getPassengers() + "\n" + jamal.calculateTollPrice());
        // System.out.println(jamal.isElectric() + "\n" + jamal.isDiscountApplied());
        // jamal.printCar();
        // System.out.println(jamal.getFareCollected());
        // jamal.printTaxi();
